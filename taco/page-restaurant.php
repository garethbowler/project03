...
$comments=types_child_posts('restaurants');
?>
...
<div class="container">
 ...
 <div class="col-xs-6 col-xs-offset-3">
	<div class="picture-container col-xs-12">
		...
		<?php  echo types_render_field("address", array("output"=>"raw"));?><br>
		<?php  stars(types_render_field("restaurant-rating", array("output"=>"raw")));?><br>
	<p>
